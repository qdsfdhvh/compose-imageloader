...
internal class MovieDrawable @JvmOverloads constructor(
    ...
    private var pixelOpacity = PixelOpacity.UNCHANGED
    ...
    fun setAnimatedTransformation(animatedTransformation: AnimatedTransformation?) {
        ...
        if (animatedTransformation != null && movie.width() > 0 && movie.height() > 0) {
            ...
            pixelOpacity = PixelOpacity.UNCHANGED
    ...
    override fun getOpacity(): Int {
        return if (paint.alpha == 255 &&
            (pixelOpacity == PixelOpacity.OPAQUE || (pixelOpacity == PixelOpacity.UNCHANGED && movie.isOpaque))
        ) {
            PixelFormat.OPAQUE
        } else {
