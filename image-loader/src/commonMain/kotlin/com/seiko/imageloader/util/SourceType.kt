...
internal suspend fun isSvg(channel: ByteReadChannel): Boolean {
 ...
 */
internal suspend fun isGif(source: ByteReadChannel): Boolean {
 ...
 */
internal suspend fun isWebP(source: ByteReadChannel): Boolean {
 ...
 */
internal suspend fun isAnimatedWebP(source: ByteReadChannel): Boolean {
 ...
 */
internal suspend fun isHeif(source: ByteReadChannel): Boolean {
 ...
 * consumed.
 */
internal suspend fun isAnimatedHeif(source: ByteReadChannel): Boolean {
