...
fun OtherImagesScene(
    ...
    BackScene(
        ...
        var changeIndex by remember { mutableStateOf(0) }
        ...
        LazyColumn(
            ...
            item {
                Column {
                    Row {
                        Image(
                            rememberImagePainter(changeUrl),
                        ...
                        Column {
                            Text(changeIndex.toString())
                            Spacer(Modifier.height(6.dp))
                            Text(changeUrl, maxLines = 3)
                        }
                    }
                    Spacer(Modifier.height(6.dp))
                    Button(
                        onClick = {
                            if (changeIndex >= images.lastIndex) {
                                changeIndex = 0
                            } else {
                                changeIndex++
                            }
